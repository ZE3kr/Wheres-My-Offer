...
<main role="main" class="container mt-5">
	...
	<h2 class="mt-4" id="status">Real time status
		<br/><button type="button" class="btn btn-success">
			Ad <span class="badge badge-light"><?php echo $n_admit; ?></span>
		</button>
		<button type="button" class="btn btn-danger">
			Rej <span class="badge badge-light"><?php echo $n_reject; ?></span>
		</button>
		<button type="button" class="btn btn-primary">
			Rvw <span class="badge badge-light"><?php echo $n_review; ?></span>
		</button>
		<button type="button" class="btn btn-warning">
			Wt <span class="badge badge-light"><?php echo $n_waiting; ?></span>
		</button>
	</h2>
	<p class="text-muted small">This program retrieves the status from Portals and Emails real time. The judgement might be incorrect.</p>
		...
		<?php foreach ($translate as $univ => $status) { ?>
			<div class="list-group-item list-group-item-action list-group-item-light col-md-6 col-lg-4 col-xl-3">
				<div class="d-flex w-100 justify-content-between">
					...
					<small style="text-align: right; line-height: 1.75;" class="mt-1"><strong>Not Submitted</strong></small>
				</div>
			</div>
		<?php } ?>
	</div>
